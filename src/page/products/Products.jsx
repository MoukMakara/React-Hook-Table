      ...
      <Modal show={openModal} onClose={() => setOpenModal(false)}>
        ...
        <Modal.Body>
          <div className="space-y-6">
            <img
              className="w-40 h-40 object-cover align-center rounded-lg"
              src={productDetail?.image || "../assets/img1.png"}
              alt=""
            />
            <h2 className="text-[30px] text-blue-600 font-bold">
              {productDetail?.name || "Unknown"}
            </h2>
            <p className="text-base leading-relaxed text-gray-500 dark:text-gray-700 text-[20px]">
              {productDetail?.desc || "Product not found"}
            </p>
            <h3 className="text-[30px] text-red-400">
              {productDetail?.price || "Price not found"}$
            </h3>
          </div>
        </Modal.Body>
      </Modal>
